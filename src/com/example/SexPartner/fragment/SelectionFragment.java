...
import com.example.SexPartner.adapter.BaseListElement;
import com.example.SexPartner.activity.LoginFaceBookActivity;
import com.example.SexPartner.activity.ShowListFriendActivity;
...
public class SelectionFragment extends Fragment
{
    ...
    public static LoginFaceBookActivity activity;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        activity = (LoginFaceBookActivity) getActivity();
            ...
            public void onCompleted(GraphUser user, Response response)
            {
                if (session == Session.getActiveSession())
                {
                    if (user != null)
                    {
                        ...
                        {
                            startPickerActivity(ShowListFriendActivity.FRIEND_PICKER, 2);
                        }
                        else
                        {
...
//
    ...
    private void startPickerActivity(Uri data, int requestCode)
    {
        ...
        intent.setData(data);
        intent.setClass(getActivity(), ShowListFriendActivity.class);
    ...
    private class PeopleListElement extends BaseListElement
    {
            ...
            return new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    if (Session.getActiveSession() != null &&
                            Session.getActiveSession().isOpened())
                    {
                        startPickerActivity(ShowListFriendActivity.FRIEND_PICKER, getRequestCode());
                    }
                    else
                    {
                        activity.showSettingsFragment();
        ...
        {
            selectedUsers = ((SexPartnerApplication) getActivity().getApplication()).getSelectedUsers();
            setUsersText();
            notifyDataChanged();
        }
